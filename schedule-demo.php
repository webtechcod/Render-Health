                        ...
                        <form id="contact-form" method="post" action="" role="form">
                            <div class="controls">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label class="contact-section-label-name">TYPE OF SPECIALITY</label>
                                           <input type="text" name="email" class="form-control" placeholder="Type Of Speciality" required="required" data-error="Module Interest is required.">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label class="contact-section-label-name">NAME OF FACILITY</label>
                                            <input type="text" name="email" class="form-control" placeholder="Name of Facility" required="required" data-error="Name of Facility is required.">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label class="contact-section-label-name">MODULE INTEREST</label>
                                            <input type="text" name="email" class="form-control" placeholder="Module Interest" required="required" data-error="Module Interest is required.">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label class="contact-section-label-name">LOCATION</label>
                                            <input type="text" name="email" class="form-control" placeholder="Location" required="required" data-error="Location is required.">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
